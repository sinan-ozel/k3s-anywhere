...
echo "==="
echo ""
echo "Note: AWS_REGION, EXTERNAL_DNS, and HOSTED_ZONE_ID belong in your provider config"
echo "      file (e.g. configs/aws/my-cluster-us-east-1.env), not in GitHub Secrets."
echo ""
